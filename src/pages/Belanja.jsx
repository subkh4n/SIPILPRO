    ...
    <div className="animate-in">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Pencatatan pembelian material dengan split-bill per proyek
        </p>
      </div>
        ...
        >
          ...
          {isDebt && (
            <div
              ...
              style={{ marginTop: "var(--space-3)", maxWidth: "200px" }}
            >
      ...
      <div className="card mb-6" style={{ marginBottom: "var(--space-6)" }}>
        ...
        <div
          className="item-row desktop-only"
          style={{
            fontWeight: "600",
          ...
          >
            ...
            >
              ...
              <strong className="font-mono">
                {formatCurrency(
                  calculations.itemsWithTotal.find((i) => i.id === item.id)
                    ?.total || 0
                )}
              </strong>
            </div>
      ...
      <div className="validation-bar">
        <div className="validation-item">
          ...
          <span className="value font-mono">
            {formatCurrency(calculations.totalItems)}
          </span>
        </div>
        <div className="validation-item">
          <span className="label">Total Header:</span>
          <span className="value font-mono">
            {formatCurrency(calculations.headerTotal)}
          </span>
        </div>
        <div
          className={`validation-status ${
            calculations.isMatch ? "match" : "mismatch"
          }`}
        >
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: "0.75rem", marginTop: "2px" }}>
              Total item belum sama dengan total yang tertera di nota. Periksa
              kembali itemisasi.
            </p>
          </div>
        </div>
